...
class Bidirectional_LSTM_option(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--save_epoch', type=int, default=2, help='model save epoch step')
        parser.add_argument('--print_every', type=int, default=2, help='print loss epoch step')
        parser.add_argument('--plot_every', type=int, default=2, help='plot loss epoch step')
