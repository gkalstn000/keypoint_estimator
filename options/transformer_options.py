...
class Transformer(Base_option):
    def initialize(self):
        ...
        parser.add_argument('--n_layers', type=int, default=2, help='number of bidirectional lstm layers')
        ...
        parser.add_argument('--n_heads', type=int, default=2, help='number of bidirectional lstm layers')
